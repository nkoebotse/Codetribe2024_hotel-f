...
const Checkout = () => {
  ...
  const [total, setTotal] = useState(0); // Initial total
  const [confirmation, setConfirmation] = useState("");

  // Calculate the total amount based on the booked rooms
  useEffect(() => {
    const calculatedTotal = cart.reduce((sum, booking) => sum + booking.price, 0);
